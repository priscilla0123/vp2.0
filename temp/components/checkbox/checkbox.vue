...
<div class="checkbox">
    ...
    <span class="icon-checkbox">
        ...
        <template v-else>
            <vp-icon  v-if="!(checked || state)" name="checkbox-normal" size="18" :color="disabled ? '#D9D9D9' : '#4475e8'"></vp-icon>
            <vp-icon v-if="(checked || state)" name="checkbox-select" size="18" :color="disabled ? '#D9D9D9' : '#4475e8'"></vp-icon>
